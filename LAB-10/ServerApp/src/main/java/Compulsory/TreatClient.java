...
class TreatClient implements Runnable{
    ...
    public TreatClient(Socket socket,ServerSocket serverSocket)
    {
     ...
     {
         try {
             File fileReader = new File("/home/iulian/Public/Facultate/Programare-avansata/LAB-10/ServerApp/src/main/java/Compulsory/users.txt");
     ...
     public void addUser(String user) throws Exception
     {
         ...
         try {
             fw = new FileWriter("/home/iulian/Public/Facultate/Programare-avansata/LAB-10/ServerApp/src/main/java/Compulsory/users.txt", true);
             bw = new BufferedWriter(fw);
             pw = new PrintWriter(bw);
             pw.println(user);
             //System.out.println("Data Successfully appended into file");
     ...
     public void sendMsg(String user,String msg){
        ...
        for(int i=0;i<friends.length;i++)
        {
            ...
            PrintWriter pw = null;
            try {
                fw = new FileWriter("/home/iulian/Public/Facultate/Programare-avansata/LAB-10/ServerApp/src/main/java/Compulsory/messages.txt", true);
                bw = new BufferedWriter(fw);
                pw = new PrintWriter(bw);
    ...
    public String readMsg(String user){
        String res = "";
        try {
            File fileReader = new File("/home/iulian/Public/Facultate/Programare-avansata/LAB-10/ServerApp/src/main/java/Compulsory/messages.txt");
            Scanner Reader = new Scanner(fileReader);
            while (Reader.hasNextLine()) {
                String data = Reader.nextLine();
                String [] lineComponents = data.split(":");
